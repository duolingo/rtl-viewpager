...
and other configuration changes.  Although RTL support has bee present as part of Android since version 4.2, the `ViewPager`
...
dependencies {
    ...
    compile 'com.duolingo.open:rtl-viewpager:1.0.0'
}
```
